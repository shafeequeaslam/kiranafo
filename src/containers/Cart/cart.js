                    ...
                    <div style={{ width: '50%', marginTop: 35 }}>
                        ...
                        <div style={{ width: '100%', display: 'flex', justifyContent: 'flex-end', height: 50, marginTop: 10 }}>
                            ...
                            <div style={{ width: 'auto' }}>
                                <button className="search_btn" style={{ borderRadius: 0, backgroundColor: '#fff', color: '#cf2717', border: '1px solid #cf2717' }}><Link to="#" onClick={()=>this.create_cart()}>Proceed to Checkout</Link> </button>
                            </div>
                        </div>
                    </div>
                </div>
